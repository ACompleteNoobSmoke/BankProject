...
public class menu {
	...
	public void path(int choice) throws SQLException {
		...
		case 3: System.out.println("Thank You\nHave A Good Day...."); 
		        scan.close(); AdminMenu.scan.close(); System.exit(0); 
		}
	...
	public void userMenu(user user) throws SQLException {
		...
		System.out.println("Hello " + user.getF_name().concat(" " + user.getL_name()) + " || Checking Amount: $" + user.getCheck() + " || Saving Amount: $" + user.getSave());
		System.out.println("\n1. Withdraw");
	...
	public void userMethods(int i, user user) throws SQLException {
		switch(i) {
			...
			case 4: userInfo(user); break;
			case 5: path(mainmenu()); break;
		}
	}
